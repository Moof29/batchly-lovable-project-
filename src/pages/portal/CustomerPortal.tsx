...
export const CustomerPortal = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 flex flex-col">
      <div className="flex flex-col md:flex-row md:items-center gap-4 px-4 md:px-12 pt-6 md:pt-10 bg-white shadow-lg rounded-xl mx-auto w-full max-w-7xl">
        <Button variant="outline" size="sm" onClick={handleBack} aria-label="Back to Admin">
      ...
      <div className="flex-1 flex flex-col items-stretch px-2 sm:px-4 md:px-12 py-4 md:py-6 mx-auto w-full max-w-7xl gap-6">
        <Card className="mb-0 bg-white shadow-lg rounded-xl">
          <CardHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 flex-1 flex flex-col">
          <TabsList className="grid grid-cols-2 sm:grid-cols-4 gap-2 w-full max-w-full rounded-md overflow-x-auto">
          ...
          <TabsContent value="invoices" className="space-y-4 flex-1">
            <Card className="bg-white shadow-lg rounded-xl">
              <CardHeader>
          ...
          <TabsContent value="payments" className="space-y-4 flex-1">
            <Card className="bg-white shadow-lg rounded-xl">
              <CardHeader>
          ...
          <TabsContent value="messages" className="space-y-4 flex-1">
            <Card className="bg-white shadow-lg rounded-xl">
              <CardHeader>
