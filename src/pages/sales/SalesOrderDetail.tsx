          ...
          <CardContent>
            <dl className="space-y-4">
              <div>
                ...
                <dd className="text-sm">{order.customer_profile?.display_name}</dd>
              </div>
              <div>
          ...
          <CardContent>
            <dl className="space-y-4">
              <div>
                ...
                <dd className="text-sm">${order.subtotal.toFixed(2)}</dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">Tax</dt>
                <dd className="text-sm">${order.tax_total.toFixed(2)}</dd>
              </div>
              <div>
        ...
        <Card className="md:col-span-2">
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                {order.sales_order_line_item?.map((item) => (
